...
void run_solver_2(int _n, double _tau, int _time_step_cnt, double _sigma) {
    double a = 0.;
    double b = 1.;
    double a_coef = 1.;
    int time_step_cnt = _time_step_cnt;
    ...
    double h_sq = h * h;
    print_params(n_1 - 1, n_1, a_coef, sigma, sigma_sq, h, h_sq, tau, time_step_cnt);
    solve_2(n_1, h, h_sq, h_2, sigma_sq, sigma, a, b, a_coef, tau, time_step_cnt);
}
...
void run_solver_2() {
    ...
    double sigma = 1.;
    int n = 20;
    run_solver_2(n, tau, time_step_cnt, sigma);
}
...
TEST_CASE("mfg2_solver_2", "[run_solver_2]") {
    run_solver_2();
}